...
var Glow = {
    ...
    //Auto submit background image to prevent submit without uploaded image
    jQuery(function () {
        $('.node-type-quiz-ddlines .field-widget-image-image, .page-node-add-quiz-ddlines .field-widget-image-image').delegate('.form-file', 'change', function () {
