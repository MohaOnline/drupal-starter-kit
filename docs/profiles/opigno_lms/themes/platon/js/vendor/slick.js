...
|___/_|_|\___|_|\_(_)/ |___/
 ...
 Website: http://kenwheeler.github.io
  ...
  Update Fred Juvaux:
  Downward compatiblity with jQuery 1.4
...
(function(factory) {
    ...
    Slick.prototype.initDotEvents = function() {
        ...
        if (_.options.dots === true && _.options.pauseOnDotsHover === true && _.options.autoplay === true) {
            $('li', _.$dots)
                .bind('mouseenter.slick', _.setPaused.bind(_, true))
                .bind('mouseleave.slick', _.setPaused.bind(_, false));
        }
    ...
    Slick.prototype.initializeEvents = function() {
        ...
        if (_.options.autoplay === true) {
            $(document).bind(_.visibilityChange, _.visibility.bind(_));
        }

        _.$list.bind('mouseenter.slick', _.setPaused.bind(_, true));
        _.$list.bind('mouseleave.slick', _.setPaused.bind(_, false));
        ...
        $(window).bind('orientationchange.slick.slick-' + _.instanceUid, _.orientationChange.bind(_));

        $(window).bind('resize.slick.slick-' + _.instanceUid, _.resize.bind(_));
    ...
    Slick.prototype.lazyLoad = function() {
        ...
        function loadImages(imagesScope) {
            $('img[data-lazy]', imagesScope).each(function() {
                ...
                imageToLoad.delegateload = function() {
                    image.animate({
                        opacity: 1
                    }, 200);
                };
