    ...
    <div class="sp-bx col-xs-12">
      ...
      <div class="row">
        <div class="col-xs-11 col-md-8">
          <img src="/profiles/wetkit/libraries/theme-gcweb-v5/assets/sig-spl.svg" alt="<?php print t('Government of Canada / Gouvernement du Canada'); ?>" />
        </div>
      </div>
      <div class="row">
    ...
    <div class="sp-bx-bt col-xs-12">
      <div class="row">
        ...
        <div class="col-xs-5 col-md-4 text-right mrgn-bttm-md">
          <img src="/profiles/wetkit/libraries/theme-gcweb-v5/assets/wmms-spl.svg" alt="<?php print t('Symbol of the Government of Canada / Symbole du gouvernement du Canada'); ?>" />
        </div>
      </div>
    </div>
  </div>
