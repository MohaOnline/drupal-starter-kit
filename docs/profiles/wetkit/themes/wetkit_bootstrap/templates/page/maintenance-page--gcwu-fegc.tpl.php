...
<header role="banner" class="<?php print $container_class; ?>">
<div id="wb-bnr" class="row">
<div class="row">
<div class="col-sm-6">
<img id="gcwu-sig" src="/profiles/wetkit/libraries/theme-gcwu-fegc/assets/sig-alt-en.svg" alt="Government of Canada" />
</div>
<div class="col-sm-6">
<img id="wmms" src="/profiles/wetkit/libraries/theme-gcwu-fegc/assets/wmms-alt.svg" alt="Symbol of the Government of Canada" />
</div>
</div>
</div>
</header>
