...
/**
 *  @file
 *  Create the 'BlipTV' tab for the WYSIWYG plugins.
 */

// (function ($) {
//   namespace('Drupal.media.browser.plugin');
//
//   Drupal.media.browser.plugin.media_bliptv = function(mediaBrowser, options) {
//     return {
//       init: function() {
//         tabset = mediaBrowser.getTabset();
//         tabset.tabs('add', '#media_bliptv', 'BlipTV');
//         mediaBrowser.listen('tabs.show', function (e, id) {
//           if (id == 'media_bliptv') {
//             // We only need to set this once.
//             // We probably could set it upon load.
//             if (mediaBrowser.getActivePanel().html() == '') {
//               mediaBrowser.getActivePanel().html(options.media_bliptv);
//             }
//           }
//         });
//       }
...
//   //@todo: needs a review.
//   Drupal.media.browser.register('media_bliptv', Drupal.media.browser.plugin.media_bliptv, {});
// })(jQuery);

(function ($) {
  namespace('media.browser.plugin');

  Drupal.media.browser.plugin.bliptv_library = function(mediaBrowser, options) {

    return {
      mediaFiles: [],
      init: function() {
        tabset = mediaBrowser.getTabset();
        tabset.tabs('add', '#bliptv_library', 'BlipTV');
        var that = this;
        mediaBrowser.listen('tabs.show', function (e, id) {
          if (id == 'bliptv_library') {
  ...
  Drupal.media.browser.register('bliptv_library', Drupal.media.browser.plugin.bliptv_library);
})(jQuery);
