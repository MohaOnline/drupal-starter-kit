...
namespace Drupal\openlayers\Legacy;
...
class Drupal7 {
   ...
   * @param array $options
   *   An associative array of additional options. Defaults to an empty array.
   *   It may contain the following elements.
   *   - 'attributes': An associative array of HTML attributes to apply to the
   *     anchor tag. If element 'class' is included, it must be an array;
   *     'title' must be a string; other elements are more flexible,
   ...
   *     HTTPS respectively. TRUE enforces HTTPS and FALSE enforces HTTP,
   *     but HTTPS can only be enforced when the variable 'https' is set to
   *     TRUE.
   ...
   *
   * All arguments are passed by value. Use drupalAlter() if you need to pass
   ...
   *     'foo' => 'bar',
   *   );
   *   drupalAlter('mymodule_data', $alterable1, $alterable2, $context);
   * @endcode
   *
   ...
   *   );
   *   drupalAlter('mymodule_data', $data, $context);
   * @endcode
   *
   * @param string $type
   ...
   *   values in $type. For example, when Form API is using drupalAlter() to
   ...
   *   to drupalAlter().
   */
  public function drupalAlter(string $type, array &$data, array &$context1 = NULL, array &$context2 = NULL, array &$context3 = NULL) {
    drupalAlter($type, $data, $context1, $context2, $context3);
  }
   ...
   */
  public function drupalLoad($type, $name) {
    return drupalLoad($type, $name);
  }
