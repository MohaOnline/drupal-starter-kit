...
use OpenlayersSymfony\Component\DependencyInjection\ScopeInterface;
...
class Container implements ContainerInterface {
  ...
  public function get($name, $invalidBehavior = ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE) {
    ...
    try {
      ...
      elseif (!empty($definition['factory_method'])) {
        ...
        // FIX Allow dynamic class definitions via parameters.
   ...
   */
  protected function expandArguments(array $arguments, $invalidBehavior = ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE) {
