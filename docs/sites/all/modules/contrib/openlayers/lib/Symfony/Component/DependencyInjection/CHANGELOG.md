...
* added DecoratorServicePass and a way to override a service definition
 ...
 * added Extension::isConfigEnabled() to ease working with enableable
   configurations
 * added an Extension base class with sensible defaults to be used in
   conjunction
