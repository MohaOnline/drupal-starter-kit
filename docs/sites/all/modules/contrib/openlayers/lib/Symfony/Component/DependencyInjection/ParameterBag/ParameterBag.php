...
use OpenlayersSymfony\Component\DependencyInjection\Exception\ParameterCircularReferenceException;
...
class ParameterBag implements ParameterBagInterface {
   ...
   *   An array of keys that are being resolved (used internally to detect
   *   circular references).
   *
   * @return mixed
   *   The resolved value.
   ...
   * @throws \OpenlayersSymfony\Component\DependencyInjection\Exception\ParameterCircularReferenceException
   ...
   * @param array $resolving
   *   An array of keys that are being resolved (used internally
