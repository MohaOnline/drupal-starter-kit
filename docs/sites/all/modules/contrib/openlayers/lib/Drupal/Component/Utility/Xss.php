...
class Xss {
   ...
   * @var array
   *
   * @see \OpenlayersDrupal\Component\Utility\Xss::filterAdmin()
   */
  protected static $adminTags = array(
   ...
   *   valid UTF-8.
   *
   * @see \OpenlayersDrupal\Component\Utility\Unicode::validateUtf8()
   * @see \OpenlayersDrupal\Component\Utility\SafeMarkup
   *
   * @ingroup sanitization
   */
  public static function filter(
    $string,
    array $html_tags = array(
    ...
    // point and any HTML tags remaining will have been deliberately allowed,
    // so it is acceptable to call SafeMarkup::set() on the resultant string.
   ...
   * is desired (so
   * \OpenlayersDrupal\Component\Utility\SafeMarkup::checkPlain()
   * is not acceptable).
   *
      ...
      switch ($mode) {
        case 0:
          ...
          if (preg_match('/^([-a-zA-Z]+)/', $attributes, $match)) {
            ...
            // such attributes.
            // @see \OpenlayersDrupal\Component\Utility\UrlHelper::filterBadProtocol()
