 ...
 *
 * @see \OpenlayersDrupal\Core\Annotation\Translation
 */
class TranslationWrapper {
   ...
   *
   * @var \OpenlayersDrupal\Core\StringTranslation\TranslationInterface
   */
   ...
   *
   * @return \OpenlayersDrupal\Core\StringTranslation\TranslationInterface
   *   The string translation service.
   */
