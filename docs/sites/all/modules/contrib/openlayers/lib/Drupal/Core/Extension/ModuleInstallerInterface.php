...
interface ModuleInstallerInterface {
   ...
   *
   * @throws \OpenlayersDrupal\Core\Extension\MissingDependencyException
   ...
   *
   * @param \OpenlayersDrupal\Core\Extension\ModuleUninstallValidatorInterface $uninstall_validator
