...
namespace OpenlayersDrupal\Component\EventDispatcher;

use OpenlayersSymfony\Component\DependencyInjection\IntrospectableContainerInterface;
use OpenlayersSymfony\Component\EventDispatcher\Event;
use OpenlayersSymfony\Component\EventDispatcher\EventDispatcherInterface;
use OpenlayersSymfony\Component\EventDispatcher\EventSubscriberInterface;
...
class ContainerAwareEventDispatcher implements EventDispatcherInterface {
   ...
   *
   * @var \OpenlayersSymfony\Component\DependencyInjection\IntrospectableContainerInterface
   */
  protected $container;
   ...
   *
   * @param \OpenlayersSymfony\Component\EventDispatcher\IntrospectableContainerInterface $container
   *   The service container.
