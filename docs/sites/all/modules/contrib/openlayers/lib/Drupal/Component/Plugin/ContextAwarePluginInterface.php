...
use OpenlayersDrupal\Component\Plugin\Context\ContextInterface;
...
interface ContextAwarePluginInterface extends PluginInspectionInterface {
   ...
   *
   * @return \OpenlayersDrupal\Component\Plugin\Context\ContextDefinitionInterface[]
   ...
   *
   * @throws \OpenlayersDrupal\Component\Plugin\Exception\PluginException
   ...
   *
   * @return \OpenlayersDrupal\Component\Plugin\Context\ContextInterface
   *   The context object.
   */
   ...
   * @param string $name
   *   The name of the context in the plugin configuration.
   * @param \OpenlayersDrupal\Component\Plugin\Context\ContextInterface $context
   ...
   *
   * @return \OpenlayersDrupal\Component\Plugin\ContextAwarePluginInterface
   ...
   *
   * @return \OpenlayersSymfony\Component\Validator\ConstraintViolationListInterface
