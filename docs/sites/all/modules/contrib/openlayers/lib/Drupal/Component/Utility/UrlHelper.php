...
class UrlHelper {
   ...
   *
   * FIX Remove this function once PHP 5.4 is required as we can use just
   ...
   *
   * @see \OpenlayersDrupal\Core\Utility\LinkGenerator
  ...
  public static function parse($url) {
    ...
    // Internal URLs.
      ...
      // E.g. the relative URL "foo/bar:1" isn't properly parsed.
   ...
   * check_url() or OpenlayersDrupal\Component\Utility\Xss::filter(), but those
   * functions
   ...
   * that will call \OpenlayersDrupal\Component\Utility\SafeMarkup::checkPlain()
   * separately.
   *
   * @param string $uri
