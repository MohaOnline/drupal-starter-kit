...
namespace OpenlayersDrupal\Core\StringTranslation;
...
interface TranslationInterface {
   ...
   *   See \OpenlayersDrupal\Component\Utility\SafeMarkup::format() for details.
   * @param array $options
   ...
   *
   * @see \OpenlayersDrupal\Component\Utility\SafeMarkup::format()
   */
   ...
   *   themed. See \OpenlayersDrupal\Component\Utility\SafeMarkup::format().
   *   Note that you do
