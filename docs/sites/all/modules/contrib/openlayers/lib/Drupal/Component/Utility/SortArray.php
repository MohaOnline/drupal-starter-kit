...
class SortArray {
   ...
   *   The comparison result for uasort().
   */
  public static function sortByWeightProperty(array $a, array $b) {
    return static::sortByKeyInt($a, $b, '#weight');
  }
   ...
   *   The comparison result for uasort().
   */
  public static function sortByTitleElement(array $a, array $b) {
   ...
   *   The comparison result for uasort().
   */
  public static function sortByTitleProperty(array $a, array $b) {
    return static::sortByKeyString($a, $b, '#title');
  }
   ...
   *   The comparison result for uasort().
   */
  public static function sortByKeyString(array $a, array $b, $key) {
   ...
   *   The comparison result for uasort().
   */
  public static function sortByKeyInt(array $a, array $b, $key) {
