...
namespace OpenlayersDrupal\Component\Graph;
...
class Graph {
   ...
   *   - 'paths': Contains a list of vertices than can be reached on a path
   *     from this vertex.
   ...
   *
   * @see \OpenlayersDrupal\Component\Graph\Graph::searchAndSort()
   */
  protected function depthFirstSearch(array &$state, array $start, array &$component = NULL) {
