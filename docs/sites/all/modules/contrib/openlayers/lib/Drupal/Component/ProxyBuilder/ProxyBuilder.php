...
namespace OpenlayersDrupal\Component\ProxyBuilder;
 ...
 *
 * @see \OpenlayersDrupal\Component\ProxyBuilder
 */
 ...
 *
 * @var \OpenlayersSymfony\Component\DependencyInjection\ContainerInterface
 */
protected $container;
...
EOS;
  ...
  protected function buildConstructorMethod() {
    $output = <<<'EOS'
public function __construct(\OpenlayersSymfony\Component\DependencyInjection\ContainerInterface $container, $serviceId)
{
