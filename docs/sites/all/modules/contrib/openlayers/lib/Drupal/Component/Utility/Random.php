...
class Random {
   ...
   *
   * @see \OpenlayersDrupal\Component\Utility\Random::name()
   */
   ...
   *   Randomly generated string.
   *
   * @see \OpenlayersDrupal\Component\Utility\Random::string()
   */
   ...
   *
   * Generate a string that looks like a word (letters only, alternating
