...
interface ModuleHandlerInterface {
   ...
   *
   * @return \OpenlayersDrupal\Core\Extension\Extension[]
   ...
   *
   * @param \OpenlayersDrupal\Core\Extension\Extension[] $module_list
   *   An associative array whose keys are the names of the modules and whose
   *   values are Extension objects.
   */
   ...
   *   OpenlayersDrupal\Core\Extension\ExtensionDiscovery scan.
   *
   * @return array
   ...
   *
   * @see \OpenlayersDrupal\Core\Extension\ExtensionDiscovery
   */
   ...
   * absolutely required that no implementation alters a passed object
   * in $context, then an object needs to be cloned:
   * @code
   *   $context = array(
   ...
   *   argument. For example, when altering a 'form', $data will be a
