...
namespace OpenlayersDrupal\Component\Plugin\Factory;

use OpenlayersDrupal\Component\Plugin\Discovery\DiscoveryInterface;
use OpenlayersDrupal\Component\Plugin\Exception\PluginException;
 ...
 * factory such as OpenlayersDrupal\Component\Plugin\Factory\ReflectionFactory.
 */
class DefaultFactory implements FactoryInterface {
   ...
   *
   * The object that retrieves the definitions of the plugins that this factory
   * instantiates.
   *
   ...
   * FIX - insert comment here.
   *
   * Constructs a OpenlayersDrupal\Component\Plugin\Factory\DefaultFactory
   * object.
   *
  ...
  /**
   * Implements OpenlayersDrupal\Component\Plugin\Factory\FactoryInterface::createInstance().
   */
