...
class Number {
   ...
   */
  public static function validStep(numeric $value, numeric $step, numeric $offset = 0.0) {
   ...
   *
   * @see \OpenlayersDrupal\Component\Utility\Number::alphadecimalToInt
   */
   ...
   *   The integer value.
   *
   * @see \OpenlayersDrupal\Component\Utility\Number::intToAlphadecimal
   */
