...
namespace OpenlayersDrupal\Component\Datetime;
...
class DateTimePlus {
   ...
   * @see __construct()
   */
  public static function createFromDateTime(\DateTime $datetime, array $settings = array()) {
   ...
   *
   * @return static
   *   A new \OpenlayersDrupal\Component\DateTimePlus object based on the
   *   parameters passed in.
   */
  public static function createFromArray(array $date_parts, $timezone = NULL, array $settings = array()) {
   ...
   * @see __construct()
   */
  public static function createFromTimestamp($timestamp, $timezone = NULL, array $settings = array()) {
   ...
   * @see __construct()
   */
  public static function createFromFormat($format, $time, $timezone = NULL, array $settings = array()) {
   ...
   */
  public function __construct($time = 'now', $timezone = NULL, array $settings = array()) {
  ...
  public function __call($method, $args) {
    // FIX consider using assert() as per https://www.drupal.org/node/2451793.
   ...
   */
  public static function arrayToIso(array $array, $force_valid_date = FALSE) {
   ...
   */
  public static function prepareArray(array $array, $force_valid_date = FALSE) {
    if ($force_valid_date) {
      $now = new \DateTime();
      $array += array(
        'year'   => $now->format('Y'),
   ...
   */
  public function format($format, array $settings = array()) {
