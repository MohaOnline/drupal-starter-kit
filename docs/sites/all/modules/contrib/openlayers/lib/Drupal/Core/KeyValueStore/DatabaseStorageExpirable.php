...
use OpenlayersDrupal\Core\DestructableInterface;
...
class DatabaseStorageExpirable extends DatabaseStorage implements KeyValueStoreExpirableInterface, DestructableInterface {
  ...
  /**
   * Implements OpenlayersDrupal\Core\KeyValueStore\KeyValueStoreExpirableInterface::setWithExpireIfNotExists().
   */
  ...
  /**
   * Implements OpenlayersDrupal\Core\KeyValueStore\KeyValueStoreInterface::deleteMultiple().
   */
  ...
  /**
   * Implements OpenlayersDrupal\Core\DestructableInterface::destruct().
   */
