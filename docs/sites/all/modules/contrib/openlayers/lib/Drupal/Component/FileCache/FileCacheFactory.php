...
class FileCacheFactory {
   ...
   *
   * @return \OpenlayersDrupal\Component\FileCache\FileCacheInterface
   *   The initialized FileCache object.
   */
  public static function get($collection, array $default_configuration = array()) {
    $default_configuration += array(
      'class' => '\OpenlayersDrupal\Component\FileCache\FileCache',
