...
namespace OpenlayersDrupal\Core\State;

use OpenlayersDrupal\Core\KeyValueStore\KeyValueFactoryInterface;
...
class State implements StateInterface {
   ...
   *
   * @var \OpenlayersDrupal\Core\KeyValueStore\KeyValueStoreInterface
   */
   ...
   *
   * @param \OpenlayersDrupal\Core\KeyValueStore\KeyValueFactoryInterface $key_value_factory
   *   The key value store to use.
   */
