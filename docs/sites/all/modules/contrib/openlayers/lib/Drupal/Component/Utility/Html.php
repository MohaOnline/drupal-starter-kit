...
class Html {
  ...
  public static function getId($id) {
    ...
    // ("_"), colons (":"), and periods ("."). We strip out any character not
    // in that list. Note that the CSS spec doesn't allow colons or periods in
   ...
   *
   * Use \OpenlayersDrupal\Component\Utility\Html::serialize() to serialize this
...
EOD;
   ...
   *
   * \DOMDocument::loadHTML() in
   * \OpenlayersDrupal\Component\Utility\Html::load() makes
