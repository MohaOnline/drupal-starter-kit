...
namespace OpenlayersDrupal\Core\Annotation;

use OpenlayersDrupal\Component\Annotation\AnnotationBase;
use OpenlayersDrupal\Core\StringTranslation\TranslationWrapper;
...
class Translation extends AnnotationBase {
   ...
   *
   * @var \OpenlayersDrupal\Core\StringTranslation\TranslationWrapper
   */
