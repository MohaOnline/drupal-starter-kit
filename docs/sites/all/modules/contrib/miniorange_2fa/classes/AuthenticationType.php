...
public static $OTP_OVER_PHONE = array (
  ...
  public static function isCodeBelongsToAAuthenticator($code){
    return in_array($code,array(AuthenticationType::$GOOGLE_AUTHENTICATOR['code'],AuthenticationType::$MICROSOFT_AUTHENTICATOR['code'],AuthenticationType::$LASTPASS_AUTHENTICATOR['code'],AuthenticationType::$AUTHY_AUTHENTICATOR['code'],AuthenticationType::$DUO_AUTHENTICATOR['code']));
  }
