...
/**
 * @file
 * Default theme implementation for Audiofield XSPF slim player.
 *
 * Available variables:
 ...
 */
?>
<object type="application/x-shockwave-flash" width="175" height="14" data="<?php print $player_path; ?>?song_url=<?php print $audio_file; ?>&song_title=<?php print $audio_title; ?>">
