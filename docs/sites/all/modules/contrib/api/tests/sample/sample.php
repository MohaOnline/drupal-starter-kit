...
/**
 * Hook for testing UPPER_CASE hook linking with substitution.
 */
function hook_entity_ENTITY_TYPE_something() {
  $x = 2;
}

/**
 * Hook for testing UPPER_CASE hook linking without prefix with substitution.
 */
function hook_ENTITY_TYPE_bar() {
  $x = 2;
}
...
/**
 * Implements hook_entity_ENTITY_TYPE_something().
 */
function foo_entity_node_something() {
  $y = 3;
}
 ...
 * Implements hook_entity_ENTITY_TYPE_something().
 */
function foo_entity_three_word_type_something() {
  $y = 3;
}

/**
 * Implements hook_ENTITY_TYPE_bar().
 */
function foo_node_bar() {
  $y = 3;
}
